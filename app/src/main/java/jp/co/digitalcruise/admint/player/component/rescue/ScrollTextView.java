...
//                / scrollingLen)).intValue();
        int duration = (distance / mRndDuration) * 1000;
    ...
    public void computeScroll() {
        ...
        if (mSlr.isFinished() && (!mPaused)) {
            if(!mRndStr.equals("") && !mRndStr.equals(getText().toString())){
                setText(mRndStr);
            }
            this.startScroll(getWidth());
        }
    }
